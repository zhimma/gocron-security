...
require (
	...
	gopkg.in/alexcesaro/quotedprintable.v3 v3.0.0-20150716171945-2caba252f4dc // indirect; indirectgolang.org/x/crypto
	gopkg.in/gomail.v2 v2.0.0-20160411212932-81ebce5c23df // indirect
	gopkg.in/ini.v1 v1.67.0
	gopkg.in/macaron.v1 v1.4.0
)

replace github.com/go-xorm/xorm => xorm.io/xorm v0.7.1
